...
export const DEFAULT_SEGMENTS: Segment[] = [
  ...
  { id: '4', label: 'Sting Pong', description: 'Lift your shirt and your teammates get to smack a ping pong ball on your skin!', color: '#F59E0B', weight: 1, image: DEFAULT_SEGMENT_IMAGES[3] },
  ...
  { id: '10', label: 'Ducking ridiculous', description: 'Wear an exercise band around your knees for 2 minutes', color: '#6366F1', weight: 1, image: DEFAULT_SEGMENT_IMAGES[9] },
];
